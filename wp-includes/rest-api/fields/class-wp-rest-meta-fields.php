...
abstract class WP_REST_Meta_Fields {
	...
	protected function delete_meta_value( $object_id, $meta_key, $name ) {
		...
		if ( ! current_user_can( "delete_{$meta_type}_meta", $object_id, $meta_key ) ) {
			return new WP_Error(
				'rest_cannot_delete',
				/* translators: %s: custom.php field key */
				sprintf( __( 'Sorry, you are not allowed to edit the %s custom.php field.' ), $name ),
	 ...
	 * @param string $meta_key  Key for the custom.php field.
	 * @param string $name      Name for the field that is exposed in the REST API.
