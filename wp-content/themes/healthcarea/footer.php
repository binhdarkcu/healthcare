...
<footer id="footer" ng-if="!isLoading" class="" style="">
                ...
                <div class="row">
                    <div class="col-md-3 column_info" style="margin-bottom: 20px">
                        ...
                        <span> <i class="fa fa-map-marker"
                                  aria-hidden="true"></i> <?php echo get_field('footer_address', 'option'); ?></span><br/>
                        <span><i class="fa fa-phone"
                                 aria-hidden="true"></i> <?php echo get_field('footer_phone', 'option'); ?></span><br/>
                        <span><i class="fa fa-envelope"
                                 aria-hidden="true"></i> <?php echo get_field('footer_email', 'option'); ?></span><br/>
                        <?php if (get_field('footer_socials', 'option')): ?>
                            <ul class="social_icons">
                                <?php while (has_sub_field('footer_socials', 'option')): ?>
                                    <li>
                                        <a href="<?php echo get_sub_field('social_link'); ?>"><i
                                                    class="fa fa-<?php echo get_sub_field('social_name'); ?>"
    ...
    <div class="text-center" style="padding-top: 20px; padding-bottom: 20px;"><span style="font-style:italic">Copyright © 2017</span>
    </div>
    <!-- live support -->
