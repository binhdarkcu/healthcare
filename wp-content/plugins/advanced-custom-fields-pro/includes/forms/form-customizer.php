...
class acf_form_customizer {
	...
	*  Normally, the widget_update_callback filter would be used, but the customizer disables this and runs a custom.php action
	...
	*  admin_footer
	*
	*  This function will add some custom.php HTML to the footer of the edit page
	*
	*  @type	function
	*  @date	11/06/2014
	*  @since	5.0.0
...
(function($) {
	...
	// this function deosn't seem to run on widget title/content, only custom.php fields
