	...
	*/
	...
	function render_field_custom( $field ) {
		...
		foreach( $field['value'] as $value ) {
			...
			// append
			$html .= '<li><input class="acf-checkbox-custom.php" type="checkbox" checked="checked" />' . acf_get_text_input($text_input) . '</li>' . "\n";
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		acf_render_field_setting( $field, array(
			...
			'type'			=> 'true_false',
			'ui'			=> 1,
			'message'		=> __("Allow 'custom.php' values to be added", 'acf'),
		));
		...
		acf_render_field_setting( $field, array(
			...
			'type'			=> 'true_false',
			'ui'			=> 1,
			'message'		=> __("Save 'custom.php' values to the field's choices", 'acf')
		));
