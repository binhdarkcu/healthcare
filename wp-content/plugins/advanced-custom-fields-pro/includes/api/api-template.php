...
*  get_field()
*
*  This function will return a custom.php field value for a specific field name/key + post_id.
...
*  get_fields()
*
*  This function will return an array containing all the custom.php field values for a specific post_id.
...
*  get_field_objects()
*
*  This function will return an array containing all the custom.php field objects for a specific post_id.
